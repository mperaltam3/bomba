/*
 * RotarVueltas_ESP32_v12_Nextion.ino
...
#include "D:/DOCUMENTOS MICHAEL PERALTA/BOMBA/motor2/FTServo_Arduino/examples/SMS_STS/RotarVueltas_ESP32_v12_Nextion/SCServo.h"
...
void controlarVelocidadObjetivo(float n, unsigned long tStart, unsigned long tTotal) {
  ...
  if (speedNuevo == 0 && fabsf(faltanteFinal) > DEADBAND_VUELTAS_RESTANTES) {
    speedNuevo = (faltanteFinal > 0) ? 1 : -1;
  }

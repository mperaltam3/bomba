...
// IMPORTANTE: aunque emergencia SI pasa por este filtro de ruido (igual que
// los fines de carrera), una emergencia CONFIRMADA como real nunca ofrece
// la opcion de "continuar": rotarVueltas() la trata siempre como
// cancelacion total del movimiento (ver el "if (procesarInterrupciones())"
// en rotarVueltas(), que hace return sin pasar por esperarComandoSobre
// corriente()), y la unica forma de recuperar es un nuevo comando del
// operador (tipicamente COMANDO_REGRESO). El camino de "continuar con
// COMANDO_CONTINUAR" es EXCLUSIVO de la pausa por sobrecorriente
// (esperarComandoSobrecorriente()); la emergencia nunca pasa por ahi.

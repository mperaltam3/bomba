 ...
 *   - GPIO 14 : Sensor IR de burbuja       (CHANGE)
 *
...
#include "D:/DOCUMENTOS MICHAEL PERALTA/BOMBA/motor2/FTServo_Arduino/examples/SMS_STS/RotarVueltas_ESP32/SCServo.h"
...
bool procesarInterrupciones() {
  ...
  if (flagIRBurbuja) {
    Serial.println("[INTERRUPCION] Sensor IR de burbuja detectado! Motor detenido 5 segundos.");
    flagIRBurbuja = false;
  }
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(14), isrIRBurbuja, CHANGE);

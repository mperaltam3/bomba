/*
 * RotarVueltas_ESP32_v14_Nextion.ino
 * Version de calibracion de RotarVueltas_ESP32_v13_Nextion.
 *
 * Diferencia con v13:
...
#include "D:/DOCUMENTOS MICHAEL PERALTA/BOMBA/motor2/FTServo_Arduino/examples/SMS_STS/RotarVueltas_ESP32_v14_Nextion/SCServo.h"
...
#define MARGEN_CORRIENTE_PORCENTAJE 10.0f
...
void calibrarCorrientePorVelocidad() {
  ...
  enviarDebug("[CALIBRACION-CORRIENTE] Completa. Margen aplicado: +" +
               String(MARGEN_CORRIENTE_PORCENTAJE, 0) + "%. Envia '" + String(COMANDO_REGRESO) +
